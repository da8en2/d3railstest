...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { daily_avg_temp: @temperature.daily_avg_temp } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { daily_avg_temp: @temperature.daily_avg_temp } }
